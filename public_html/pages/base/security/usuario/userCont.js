...
(function () {
    ...
    app.controller('UserCont', ["$scope", 'UserServ', 'Pagination', function ($scope, UserServ, Pagination) {
            ...
            $scope.showPass = function (usuario) {

                UserServ.getPassword({
                    user: usuario.name
                }).success(function (data) {
                    if (data) {
                        data = 'Constraseña: ' + data;
                    } else {
                        data = 'Este usuario no tiene contraseña';
                    }
            ...
            $scope.paginate = function (tableState) {
                ...
                UserServ.filtro({
                    "jconf": JSON.stringify({
                        attrs: ['pages', 'count'],
                        list: $.jconf.filter(jconf.security.user.list, $scope.jconfFiltro)
                    }),
                    "texto": filter,
                    ...Pagination.getPagination(tableState)
                }).success(function (data) {
